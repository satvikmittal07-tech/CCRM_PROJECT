...
A comprehensive Java console application for managing students, courses, enrollments, and grades in an educational institution. Joins students and teachers across the campus and helps them stay aware of everything they must know!
...
Your project is ready to be run and executed!
How to Run
...
Import/export data
Create backups
Helps admin to have data of each and every registered student.
Enabling Assertions
